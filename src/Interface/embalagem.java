...
public class embalagem extends JFrame {
	static JTextPane empresaLb = new JTextPane();
	static JTextPane processoLb = new JTextPane();
	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	private static embalagem frame1;
	private static embalagem frame2;
	private static embalagem frame3;
	...
	public static int readConfig() {
		int a = -1;
		String file = PastaCorrente() + "config.txt";
	...
	public embalagem() {
		setTitle("embalagem (Versão 1.0.0)");
				...
				if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
					...
					if (d.existeUsuario(Refuser, Refuser)) {
						...
						if (!d.existePedido(p)) {
							...
							JLabel label = new JLabel("Esse pedido já foi inserido antes!!");
